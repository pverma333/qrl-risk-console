...
def parse_args():
    parser = argparse.ArgumentParser(description="Curated Option Chain Builder")
    parser.add_argument(
        "--mode",
...
def main():
    ...
    CuratedOptionChainBuilder(config).run(args.mode)
...
python scripts/run_curated_option_chain.py --mode incremental
"""
